...
using WeekOpdrachtDependencyInjection.Extensions;
...
namespace WeekOpdrachtDependencyInjection
{
    public class Startup
    {
        ...
        {
            var connectionString = Configuration.GetConnectionString("WeekOpdrachtDependencyInjectionDb");
            ...
            services.AddMediatR(typeof(GetMovieByIdQuery).Assembly);
